    ...
    <InteriorLayout activePage="location">
      <section className="location-page">
        <section className="location-content" aria-label="Location map and video">
          <button className="location-map-card" type="button" onClick={() => setOpenPopup("map-image")}>
          ...
          <button className="google-map-link" type="button" onClick={() => setOpenPopup("map")}>
            <img
        ...
        {openPopup && <LocationPopup type={openPopup} onClose={() => setOpenPopup(null)} />}
      </section>
    </InteriorLayout>
  );
}
